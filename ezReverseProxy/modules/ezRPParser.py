...
def setupParser():
    ...
    parser.add_argument('--no-clean-on-start', '-ncs', action='store_true', help='You should not run more than one instance of ezReverseProxy per machine. However, if you do, this flag prevents this instance from killing all other instances on startup.')
    return parser
