...
logrotateConfTemplate = os.path.join(templateDir,'logrotate.conf')
mimeConfig = os.path.join(configDirectory,'mime.types')
nginxPidFile = os.path.join(workingDirectory,'nginx.pid')
shutdownFile = os.path.join(workingDirectory,'delete_this_file_to_shutdown_ofe')
